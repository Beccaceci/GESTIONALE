...
\begin{tcolorbox}[enhanced, breakable, colback=navyblue!4!white, colframe=navyblue!80!black,
    coltitle=white, fonttitle=\bfseries\sffamily, title={Quadro Sinottico del Capitolo 01 (Corrispondenza: Lezione 01)},
...
\textbf{Trascrizione di Riferimento:} \texttt{trascrizioni/Lezione\_01\_2021-09-29\_Introduzione\_Grandezze\_Fisiche\_Vettori\_Cinematica\_1D.md}\\
...
% ------------------------------------------------------------------------------
\section{Esercizi Risolti ed Applicativi della Lezione 01}
\label{sec:esercizi_lezione_01}
% ------------------------------------------------------------------------------
